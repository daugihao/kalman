function [d] = model_train_circularPMF(s,dt)
% MODEL_TRAIN_CONSTVEL Model setup
    ...
    %% Prediction model
    d.predModel = @model_train_circularPMF_predModel;
    d.measModel = @model_train_circularPMF_measModel;
    d.stateTrans = @model_train_circularPMF_stateTrans;
